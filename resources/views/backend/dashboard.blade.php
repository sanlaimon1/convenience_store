      ...
      <div class="col-xl-9 stretch-card grid-margin">
        <div class="card">
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-sm-8">
                <p class="text-muted mb-0"> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
              ...
              <table class="table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <div class="d-flex align-items-center">
                        <img src="{{ asset('backend/template/assets/images/faces/face1.jpg') }}" alt="image" />
                  ...
                  <tr>
                    <td>
                      <div class="d-flex align-items-center">
                        <img src="{{ asset('backend/template/assets/images/faces/face10.jpg') }}" alt="image" />
                        <div class="table-user-name ml-3">
                  ...
                  <tr>
                    <td>
                      <div class="d-flex align-items-center">
                        <img src="{{ asset('backend/template/assets/images/faces/face11.jpg') }}" alt="image" />
                        <div class="table-user-name ml-3">
                  ...
                  <tr>
                    <td>
                      <div class="d-flex align-items-center">
                        <img src="{{ asset('backend/template/assets/images/faces/face13.jpg') }}" alt="image" />
                        <div class="table-user-name ml-3">
                  ...
                  <tr>
                    <td>
                      <div class="d-flex align-items-center">
                        <img src="{{ asset('backend/template/assets/images/faces/face16.jpg') }}" alt="image" />
                        <div class="table-user-name ml-3">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="d-flex flex-wrap border-bottom py-2 border-top justify-content-between">
              <img class="survey-img mb-lg-3" src="{{ asset('backend/template/assets/images/dashboard/img_3.jpg') }}" alt="" />
              <div class="pt-2">
            ...
            <div class="d-flex flex-wrap border-bottom py-2 justify-content-between">
              <img class="survey-img mb-lg-3" src="{{ asset('backend/template/assets/images/dashboard/img_1.jpg') }}" alt="" />
              <div class="pt-2">
            ...
            <div class="d-flex flex-wrap border-bottom py-2 justify-content-between">
              <img class="survey-img mb-lg-3" src="{{ asset('backend/template/assets/images/dashboard/img_2.jpg') }}" alt="" />
              <div class="pt-2">
              ...
              <div class="col-12 col-sm-7">
                <div class="row">
                  <div class="col-4 col-md-4">
                    <img class="customer-img" src="{{ asset('backend/template/assets/images/faces/face22.jpg') }}" alt="" />
                  </div>
              ...
              <div class="col-sm-7">
                <div class="row">
                  <div class="col-4 col-sm-4">
                    <img class="customer-img" src="{{ asset('backend/template/assets/images/faces/face25.jpg') }}" alt="" />
                  </div>
